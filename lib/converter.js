 ...
 * @buildAt 2021-03-05T03:24:35.629Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return parseInt(num.join(''));
        ...
        peg$c137 = "and",
        peg$c138 = peg$literalExpectation("AND", true),
        peg$c139 = "&&",
      ...
      return false;
        ...
        peg$c171 = "source",
        peg$c172 = peg$literalExpectation("SOURCE", true),
        peg$c173 = "search",
        peg$c174 = peg$literalExpectation("SEARCH", true),
        peg$c175 = "fields",
        peg$c176 = peg$literalExpectation("FIELDS", true),
        peg$c177 = "head",
        peg$c178 = peg$literalExpectation("HEAD", true),
        peg$c179 = "sort",
        peg$c180 = peg$literalExpectation("SORT", true),
        peg$c181 = "gentimes",
        peg$c182 = peg$literalExpectation("GENTIMES", true),
        peg$c183 = "size",
        peg$c184 = peg$literalExpectation("SIZE", true),
        peg$c185 = "timeout",
        peg$c186 = peg$literalExpectation("TIMEOUT", true),
        peg$c187 = "track_total_hits",
        peg$c188 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c189 = "terminate_after",
        peg$c190 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c191 = "top",
        peg$c192 = peg$literalExpectation("TOP", true),
        peg$c193 = "limit",
        peg$c194 = peg$literalExpectation("LIMIT", true),
        peg$c195 = "in",
        peg$c196 = peg$literalExpectation("IN", true),
        peg$c197 = "not in",
        peg$c198 = peg$literalExpectation("NOT IN", true),
        peg$c199 = "like",
        peg$c200 = peg$literalExpectation("LIKE", true),
        peg$c201 = "exists",
        peg$c202 = peg$literalExpectation("EXISTS", true),
        peg$c203 = "not_exists",
        peg$c204 = peg$literalExpectation("NOT_EXISTS", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c187) {
    ...
    function peg$parseTERMINATE_AFTER() {
      ...
      if (input.substr(peg$currPos, 15).toLowerCase() === peg$c189) {
    ...
    function peg$parseNOT_EXISTS() {
      ...
      if (input.substr(peg$currPos, 10).toLowerCase() === peg$c203) {
