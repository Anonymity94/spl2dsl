 ...
 * @buildAt 2022-04-24T03:17:03.268Z
 */
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      return {
        ...
        peg$c131 = /^[A-Za-z0-9_.]/,
        peg$c132 = peg$classExpectation([["A", "Z"], ["a", "z"], ["0", "9"], "_", "."], false, false),
        peg$c133 = function peg$c133(prefix, str) {
      var field = (prefix || '') + str.join(''); // TODO: 排除命令
      // 这里为什么会识别到命令前缀呢？
      ...
      return field;
        ...
        peg$c134 = peg$otherExpectation("Value"),
        peg$c135 = /^[\u4E00-\u9FA5_a-zA-Z0-9.\-?*:\/<>]/,
        peg$c136 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ".", "-", "?", "*", ":", "/", "<", ">"], false, false),
        peg$c137 = peg$otherExpectation("QuotedValue"),
        peg$c138 = /^[\u4E00-\u9FA5_a-zA-Z0-9.\-?*:\/<> ]/,
        peg$c139 = peg$classExpectation([["\u4E00", "\u9FA5"], "_", ["a", "z"], ["A", "Z"], ["0", "9"], ".", "-", "?", "*", ":", "/", "<", ">", " "], false, false),
        peg$c140 = "",
        peg$c141 = function peg$c141(num) {
      return parseInt(num.join(''));
    },
        peg$c142 = "and",
        peg$c143 = peg$literalExpectation("AND", true),
        peg$c144 = "&&",
      ...
      return AND;
        ...
        peg$c147 = "or",
        peg$c148 = peg$literalExpectation("OR", true),
        peg$c149 = "||",
      ...
      return false;
        ...
        peg$c176 = "source",
        peg$c177 = peg$literalExpectation("SOURCE", true),
        peg$c178 = "search",
        peg$c179 = peg$literalExpectation("SEARCH", true),
        peg$c180 = "fields",
        peg$c181 = peg$literalExpectation("FIELDS", true),
        peg$c182 = "head",
        peg$c183 = peg$literalExpectation("HEAD", true),
        peg$c184 = "sort",
        peg$c185 = peg$literalExpectation("SORT", true),
        peg$c186 = "gentimes",
        peg$c187 = peg$literalExpectation("GENTIMES", true),
        peg$c188 = "size",
        peg$c189 = peg$literalExpectation("SIZE", true),
        peg$c190 = "timeout",
        peg$c191 = peg$literalExpectation("TIMEOUT", true),
        peg$c192 = "track_total_hits",
        peg$c193 = peg$literalExpectation("TRACK_TOTAL_HITS", true),
        peg$c194 = "terminate_after",
        peg$c195 = peg$literalExpectation("TERMINATE_AFTER", true),
        peg$c196 = "top",
        peg$c197 = peg$literalExpectation("TOP", true),
        peg$c198 = "limit",
        peg$c199 = peg$literalExpectation("LIMIT", true),
        peg$c200 = "in",
        peg$c201 = peg$literalExpectation("IN", true),
        peg$c202 = "not in",
        peg$c203 = peg$literalExpectation("NOT IN", true),
        peg$c204 = "like",
        peg$c205 = peg$literalExpectation("LIKE", true),
        peg$c206 = "exists",
        peg$c207 = peg$literalExpectation("EXISTS", true),
        peg$c208 = "not_exists",
        peg$c209 = peg$literalExpectation("NOT_EXISTS", true),
        peg$currPos = 0,
        peg$savedPos = 0,
        peg$posDetailsCache = [{
      line: 1,
    ...
    function peg$parseTRACK_TOTAL_HITS() {
      ...
      if (input.substr(peg$currPos, 16).toLowerCase() === peg$c192) {
    ...
    function peg$parseTERMINATE_AFTER() {
      ...
      if (input.substr(peg$currPos, 15).toLowerCase() === peg$c194) {
